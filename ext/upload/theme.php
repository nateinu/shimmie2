...
class UploadTheme extends Themelet {
	...
	public function display_page(Page $page) {
		...
		if($tl_enabled) {
			$page->add_block(new Block("Bookmarklets", $this->h_bookmarklets(), "main", 30));
		}
	}
	...
	protected function h_bookmarklets() {
		...
		$html = '<p>Check out the Wiki page on <a href="'.make_http(get_base_href()).'/wiki/Transloaders">Transloaders</a>!</p><br />';
